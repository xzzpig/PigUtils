 ...
 * @author xzzpig
 */
public class DatabaseImpl extends com.github.xzzpig.pigutils.database.Database implements Closeable {
    ...
    @Override protected com.github.xzzpig.pigutils.database.Table newTable(String name) {
        return new TableImpl(name, this);
    }
