...
public class TableImpl implements com.github.xzzpig.pigutils.database.Table {
    /**
     * 更新表结构时的临时表
     */
    ...
    @Override public com.github.xzzpig.pigutils.database.Table setConstruct(TableConstruct construct) {
