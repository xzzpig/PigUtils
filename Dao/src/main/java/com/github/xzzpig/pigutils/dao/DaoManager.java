...
import com.github.xzzpig.pigutils.dao.exception.DBArrayTableCreateException;
import com.github.xzzpig.pigutils.dao.exception.DBForeignObjectCreateException;
import com.github.xzzpig.pigutils.dao.exception.NotDBTableException;
import com.github.xzzpig.pigutils.dao.exception.ResultSetSolveFailedException;
import com.github.xzzpig.pigutils.data.DataUtils;
import com.github.xzzpig.pigutils.database.DBSelector;
...
public class DaoManager {
    ...
    public @NotNull TableConstruct solveTableClass(Class<?> clazz) {
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if (check.equals(""))
                check = null;
            com.github.xzzpig.pigutils.database.DBField dbField1 = tableConstruct.createDBField(name);
    ...
    private void createArrayTable(Class<?> clazz, Field field) {
        ...
        com.github.xzzpig.pigutils.database.DBField dbField_from = solveTableClass(clazz).findPrimaryKeyField();
        com.github.xzzpig.pigutils.database.DBField dbField_to = solveTableClass(field.getType().getComponentType()).findPrimaryKeyField();
    ...
    private Map<String, Object> getFieldMap(Object obj) throws SQLException {
        ...
        Class<?> clazz = obj.getClass();
        com.github.xzzpig.pigutils.database.DBField keyField = solveTableClass(obj.getClass()).findPrimaryKeyField();
        for (Field field : clazz.getDeclaredFields()) {
    ...
    public DaoManager update(Object obj) throws SQLException {
        ...
        com.github.xzzpig.pigutils.database.DBField dbField = construct.findPrimaryKeyField();
    ...
    private Object createForeignObject(Field field, Object value) throws IllegalAccessException, SQLException, InstantiationException {
        ...
        com.github.xzzpig.pigutils.database.DBField dbField = tableConstruct.findField(foreignField);
        if (dbField == null)
    ...
    public @NotNull <T> List<T> loadByResult(@NotNull Class<T> clazz, @NotNull ResultSet resultSet) throws SQLException, IllegalAccessException, InstantiationException {
        ...
        while (resultSet.next()) {
            ...
            for (com.github.xzzpig.pigutils.database.DBField dbField : tableConstruct.getDBFields()) {
    ...
    private Object solveToObject(@NotNull ResultSet resultSet, com.github.xzzpig.pigutils.database.DBField dbField) throws SQLException {
        Field field = dbField.DaoFiled;
        Object obj = null;
        try {
    ...
    private @NotNull Object getDBArray(Class<?> clazz, Field field, Object obj) throws SQLException, IllegalAccessException, InstantiationException {
        DBArray dbArray = field.getAnnotation(DBArray.class);
        com.github.xzzpig.pigutils.database.DBField keyField = solveTableClass(clazz).findPrimaryKeyField();
        com.github.xzzpig.pigutils.database.DBField valueField = solveTableClass(field.getType().getComponentType()).findPrimaryKeyField();
        Object keyValue = getFiledData(keyField.DaoFiled, obj);
    ...
    public @NotNull <T> T fill(@NotNull T obj, @Nullable String... baseFields) throws SQLException, InstantiationException, IllegalAccessException {
        ...
        Map<com.github.xzzpig.pigutils.database.DBField, Object> baseMap = new HashMap<>();
        List<com.github.xzzpig.pigutils.database.DBField> fillList = new ArrayList<>();
        for (com.github.xzzpig.pigutils.database.DBField field : tableConstruct.getDBFields()) {
        ...
        if (results.size() > 0) {
            ...
            for (com.github.xzzpig.pigutils.database.DBField field : fillList) {
                boolean access = field.DaoFiled.isAccessible();
                field.DaoFiled.setAccessible(true);
