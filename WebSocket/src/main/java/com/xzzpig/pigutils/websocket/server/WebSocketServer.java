...
import com.xzzpig.pigutils.websocket.*;
...
public abstract class WebSocketServer extends WebSocketAdapter implements Runnable {
     ...
     * @param decodercount         The number of {@link WebSocketWorker}s that will be used to
    ...
    /**
     * @see WebSocket#sendFragmentedFrame(Opcode,
     * ByteBuffer, boolean)
     */
    ...
    /**
     * @param conn may be null if the error does not belong to a single
     *             connection
     */
    @Override
